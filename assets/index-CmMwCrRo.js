var $=t=>{throw TypeError(t)};var D=(t,e,n)=>e.has(t)||$("Cannot "+n);var l=(t,e,n)=>(D(t,e,"read from private field"),n?n.call(t):e.get(t)),f=(t,e,n)=>e.has(t)?$("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,n),E=(t,e,n,r)=>(D(t,e,"write to private field"),r?r.call(t,n):e.set(t,n),n),F=(t,e,n)=>(D(t,e,"access private method"),n);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function n(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(a){if(a.ep)return;a.ep=!0;const o=n(a);fetch(a.href,o)}})();const Y={BASE_URL:"https://story-api.dicoding.dev/v1"},k={BASE_URL:Y.BASE_URL};function Q(){return localStorage.getItem("token")}const X={async register(t,e,n){const r=await fetch(k.BASE_URL+"/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:t,email:e,password:n})}),a=await r.json();if(!r.ok)throw new Error(a.message||"Failed to register");return a}},Z={async login(t,e){const n=await fetch(k.BASE_URL+"/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,password:e})}),r=await n.json();if(!n.ok)throw new Error(r.message||"Login failed");return r}};async function ee(t=1,e=7,n=0,r=localStorage.getItem("token")){const a=new URLSearchParams;t!==void 0&&a.append("page",t),e!==void 0&&a.append("size",e),n!==void 0&&a.append("location",n);const o=await fetch(`${k.BASE_URL}/stories?${a.toString()}`,{method:"GET",headers:{Authorization:"Bearer "+r}}),i=await o.json();if(!o.ok)throw new Error(i.message||"Failed to fetch stories");return i}async function te(t,e=localStorage.getItem("token")){const n=await fetch(`${k.BASE_URL}/stories/${t}`,{method:"GET",headers:{Authorization:`Bearer ${e}`}}),r=await n.json();if(!n.ok)throw new Error(r.message||"Failed to fetch story detail");return r}async function ne(t,e,n,r){const a=Q(),o=await(await fetch(t)).blob(),i=new File([o],"photo.jpg",{type:o.type}),c=new FormData;c.append("photo",i),c.append("description",e),n&&c.append("lat",parseFloat(n)),r&&c.append("lon",parseFloat(r));const s=await fetch("https://story-api.dicoding.dev/v1/stories",{method:"POST",headers:{Authorization:`Bearer ${a}`},body:c}),d=await s.json();if(!s.ok)throw new Error(d.message);return d}class re{constructor(e){this.presenter=e}render(){return`
    ...
    `}afterRender(){document.querySelector("header").style.display="none",document.querySelector("footer").style.display="none",document.getElementById("registerForm").addEventListener("submit",n=>{n.preventDefault();const r=document.getElementById("name").value,a=document.getElementById("email").value,o=document.getElementById("password").value;this.presenter.handleRegister(r,a,o)})}showMessage(e,n=!0){const r=document.getElementById("message");r.innerText=n?`✅ ${e}`:`❌ ${e}`,r.style.color=n?"green":"red"}resetForm(){document.getElementById("registerForm").reset()}}class ie{constructor(){this.view=new oe(this)}async render(){return this.view.render()}async afterRender(){this.view.afterRender()}async handleRegister(e,n,r){try{const a=await X.register(e,n,r);this.view.showMessage(a.message,!0),this.view.resetForm(),document.startViewTransition?document.startViewTransition(()=>{window.location.hash="/"}):window.location.hash="/"}catch(a){this.view.showMessage(a.message||"Failed to register user",!1)}}}const h={render(){return document.querySelector("header").style.display="block",document.querySelector("footer").style.display="block",`
    ...
    `;e.innerHTML=n+r},showError(t){const e=document.getElementById("storyList");e.innerHTML=`<p style="color:red;">❌ ${t}</p>`},bindDetailButtons(t){document.querySelectorAll(".view-detail-button").forEach(e=>{e.addEventListener("click",n=>{const r=n.target.getAttribute("data-id");t(r)})})},bindAddButton(t){const e=document.getElementById("addStoryCard");e&&e.addEventListener("click",()=>t())},bindDeleteButtons(t){document.querySelectorAll(".delete-story-button").forEach(e=>{e.addEventListener("click",n=>{const r=n.target.getAttribute("data-id");confirm("Yakin ingin menghapus story ini?")&&t(r)})})}},P=(t,e)=>e.some(n=>t instanceof n);let x,V;function se(){return x||(x=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function ce(){return V||(V=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const M=new WeakMap,A=new WeakMap,I=new WeakMap;function de(t){const e=new Promise((n,r)=>{const a=()=>{t.removeEventListener("success",o),t.removeEventListener("error",i)},o=()=>{n(g(t.result)),a()},i=()=>{r(t.error),a()};t.addEventListener("success",o),t.addEventListener("error",i)});return I.set(e,t),e}function le(t){if(M.has(t))return;const e=new Promise((n,r)=>{const a=()=>{t.removeEventListener("complete",o),t.removeEventListener("error",i),t.removeEventListener("abort",i)},o=()=>{n(),a()},i=()=>{r(t.error||new DOMException("AbortError","AbortError")),a()};t.addEventListener("complete",o),t.addEventListener("error",i),t.addEventListener("abort",i)});M.set(t,e)}let T={get(t,e,n){if(t instanceof IDBTransaction){if(e==="done")return M.get(t);if(e==="store")return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return g(t[e])},set(t,e,n){return t[e]=n,!0},has(t,e){return t instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in t}};function G(t){T=t(T)}function ue(t){return ce().includes(t)?function(...e){return t.apply(R(this),e),g(this.request)}:function(...e){return g(t.apply(R(this),e))}}function me(t){return typeof t=="function"?ue(t):(t instanceof IDBTransaction&&le(t),P(t,se())?new Proxy(t,T):t)}function g(t){if(t instanceof IDBRequest)return de(t);if(A.has(t))return A.get(t);const e=me(t);return e!==t&&(A.set(t,e),I.set(e,t)),e}const R=t=>I.get(t);function ge(t,e,{blocked:n,upgrade:r,blocking:a,terminated:o}={}){const i=indexedDB.open(t,e),c=g(i);return r&&i.addEventListener("upgradeneeded",s=>{r(g(i.result),s.oldVersion,s.newVersion,g(i.transaction),s)}),n&&i.addEventListener("blocked",s=>n(s.oldVersion,s.newVersion,s)),c.then(s=>{o&&s.addEventListener("close",()=>o()),a&&s.addEventListener("versionchange",d=>a(d.oldVersion,d.newVersion,d))}).catch(()=>{}),c}const he=["get","getKey","getAll","getAllKeys","count"],pe=["put","add","delete","clear"],C=new Map;function q(t,e){if(!(t instanceof IDBDatabase&&!(e in t)&&typeof e=="string"))return;if(C.get(e))return C.get(e);const n=e.replace(/FromIndex$/,""),r=e!==n,a=pe.includes(n);if(!(n in(r?IDBIndex:IDBObjectStore).prototype)||!(a||he.includes(n)))return;const o=async function(i,...c){const s=this.transaction(i,a?"readwrite":"readonly");let d=s.store;return r&&(d=d.index(c.shift())),(await Promise.all([d[n](...c),a&&s.done]))[0]};return C.set(e,o),o}G(t=>({...t,get:(e,n,r)=>q(e,n)||t.get(e,n,r),has:(e,n)=>!!q(e,n)||t.has(e,n)}));const ye=["continue","continuePrimaryKey","advance"],j={},O=new WeakMap,z=new WeakMap,fe={get(t,e){if(!ye.includes(e))return t[e];let n=j[e];return n||(n=j[e]=function(...r){O.set(this,z.get(this)[e](...r))}),n}};async function*we(...t){let e=this;if(e instanceof IDBCursor||(e=await e.openCursor(...t)),!e)return;e=e;const n=new Proxy(e,fe);for(z.set(n,e),I.set(n,R(e));e;)yield n,e=await(O.get(n)||e.continue()),O.delete(n)}function N(t,e){return e===Symbol.asyncIterator&&P(t,[IDBIndex,IDBObjectStore,IDBCursor])||e==="iterate"&&P(t,[IDBIndex,IDBObjectStore])}G(t=>({...t,get(e,n,r){return N(e,n)?we:t.get(e,n,r)},has(e,n){return N(e,n)||t.has(e,n)}}));const be="story-db",ve=1,p="stories",B=ge(be,ve,{upgrade(t){t.objectStoreNames.contains(p)||t.createObjectStore(p,{keyPath:"id"})}}),w={async getAll(){return(await B).getAll(p)},async put(t){return(await B).put(p,t)},async delete(t){return(await B).delete(p,t)},async clear(){return(await B).clear(p)}};class Le{async render(){return h.render()}async afterRender(){try{const r=(await ee()).listStory;await w.clear(),await Promise.all(r.map(a=>w.put(a)))}catch(n){console.warn("Gagal fetch API, ambil dari cache:",n.message)}const e=await w.getAll();h.showStories(e),this._bindAllButtons()}_bindAllButtons(){h.bindAddButton(()=>{window.location.hash="/add"}),h.bindDetailButtons(e=>{window.location.hash=`/detail/${e}`}),h.bindDeleteButtons(async e=>{await w.delete(e);const n=await w.getAll();h.showStories(n),this._bindAllButtons()})}}const m={render(){return`
    ...
    `},showMap(t,e,n,r){const a=L.map("map").setView([t,e],13);L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:'&copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>'}).addTo(a),L.marker([t,e]).addTo(a).bindPopup(`<b>${n}</b><br>${r}`).openPopup()},showNoLocation(){document.getElementById("map").innerHTML="<p>Lokasi tidak tersedia.</p>"},showError(t){const e=document.getElementById("storyDetail");e.innerHTML=`<p style="color:red;">❌ ${t}</p>`}};class Be{async render(){return b.render()}async afterRender(){const n=window.location.hash.split("/")[2];try{const a=(await te(n)).story;b.showStoryDetail(a),a.lat!==void 0&&a.lon!==void 0?b.showMap(a.lat,a.lon,a.name,a.description):b.showNoLocation()}catch(r){b.showError(r.message)}}}const W=new ae,H=new ie,U=new Le,_=new Be,K=new Ee,Se={"/":{render:()=>W.render(),afterRender:()=>W.afterRender()},"/register":{render:()=>H.render(),afterRender:()=>H.afterRender()},"/home":{render:()=>U.render(),afterRender:()=>U.afterRender()},"/add":{render:()=>K.render(),afterRender:()=>K.afterRender()},"/detail/:id":{render:()=>_.render(),afterRender:()=>_.afterRender()}};function ke(t){const e=t.split("/");return{resource:e[1]||null,id:e[2]||null}}function Ie(t){let e="";return t.resource&&(e=e.concat(`/${t.resource}`)),t.id&&(e=e.concat("/:id")),e||"/"}function De(){return location.hash.replace("#","")||"/"}function Ae(){const t=De(),e=ke(t);return Ie(e)}const Ce="BCCs2eonMI-6H2ctvFaWg-UYdDv387Vno_bzUzALpB442r2lCnsHmtrx8biyPi_E-1fSGABK_Qs_GlvPoJJqxbk";async function Pe(t){if(!("serviceWorker"in navigator)){console.error("Service Worker tidak didukung");return}const e=await navigator.serviceWorker.register("/service-worker.js");if(await Notification.requestPermission()!=="granted")throw new Error("Izin notifikasi ditolak");const r=await e.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:Re(Ce)}),a={endpoint:r.endpoint,keys:{p256dh:r.toJSON().keys.p256dh,auth:r.toJSON().keys.auth}};await fetch("https://story-api.dicoding.dev/v1/notifications/subscribe",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t}`},body:JSON.stringify(a)})}async function Me(){if(!("serviceWorker"in navigator)){console.error("Service Worker tidak didukung");return}const t=await navigator.serviceWorker.getRegistration();if(!t){console.error("Service Worker belum terdaftar");return}const e=await t.pushManager.getSubscription();e?(await e.unsubscribe(),console.log("Berhasil berhenti berlangganan notifikasi")):console.log("Belum ada langganan notifikasi yang aktif")}async function Te(){if(!("serviceWorker"in navigator))return!1;const t=await navigator.serviceWorker.getRegistration();return t?!!await t.pushManager.getSubscription():!1}function Re(t){const e="=".repeat((4-t.length%4)%4),n=(t+e).replace(/\-/g,"+").replace(/_/g,"/"),r=atob(n),a=new Uint8Array(r.length);for(let o=0;o<r.length;++o)a[o]=r.charCodeAt(o);return a}var v,y,u,S,J;class Oe{constructor({navigationDrawer:e,drawerButton:n,content:r}){f(this,S);f(this,v,null);f(this,y,null);f(this,u,null);E(this,v,r),E(this,y,n),E(this,u,e),F(this,S,J).call(this)}async renderPage(){const e=Ae(),n=Se[e];l(this,v).innerHTML=await n.render(),await n.afterRender();const r=localStorage.getItem("token"),a=document.getElementById("subscribe-btn"),o=document.getElementById("unsubscribe-btn");a&&o&&(await Te()?(a.style.display="none",o.style.display="inline-block"):(a.style.display="inline-block",o.style.display="none"),a.addEventListener("click",async()=>{if(!r){alert("Silakan login terlebih dahulu untuk berlangganan notifikasi.");return}try{await Pe(r),alert("Berhasil berlangganan notifikasi!"),a.style.display="none",o.style.display="inline-block"}catch(c){alert("Gagal berlangganan notifikasi: "+c.message)}}),o.addEventListener("click",async()=>{try{await Me(),alert("Berhasil berhenti berlangganan notifikasi."),a.style.display="inline-block",o.style.display="none"}catch(c){alert("Gagal berhenti berlangganan: "+c.message)}}))}}v=new WeakMap,y=new WeakMap,u=new WeakMap,S=new WeakSet,J=function(){l(this,y).addEventListener("click",()=>{l(this,u).classList.toggle("open")}),document.body.addEventListener("click",e=>{!l(this,u).contains(e.target)&&!l(this,y).contains(e.target)&&l(this,u).classList.remove("open"),l(this,u).querySelectorAll("a").forEach(n=>{n.contains(e.target)&&l(this,u).classList.remove("open")})})};"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("/service-worker.js").then(t=>{console.log("Service Worker registered:",t)}).catch(t=>{console.error("Service Worker registration failed:",t)})});document.addEventListener("DOMContentLoaded",async()=>{const t=new Oe({content:document.querySelector("#main-content"),drawerButton:document.querySelector("#drawer-button"),navigationDrawer:document.querySelector("#navigation-drawer")});await t.renderPage(),window.addEventListener("hashchange",async()=>{await t.renderPage()})});document.addEventListener("DOMContentLoaded",()=>{document.querySelector(".skip-to-content").addEventListener("click",function(e){e.preventDefault(),setTimeout(()=>{const n=document.getElementById("main-content");n&&(n.setAttribute("tabindex","-1"),n.focus())},100)})});
